package com.springlessons.clinicadmin.configuration;


import com.springlessons.clinicadmin.exception.AccountException;
import com.springlessons.clinicadmin.service.UserDetailService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .hasAnyRole("CONT_MANAGER", "MODERATOR") // разрешены только пользователям с указанными ролями
